...
@Api(tags = "会员收藏的商品 管理")
@RestController
@RequestMapping("sms/umsmembercollectspu")
public class UmsMemberCollectSpuController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('sms:umsmembercollectspu:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('sms:umsmembercollectspu:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('sms:umsmembercollectspu:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('sms:umsmembercollectspu:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('sms:umsmembercollectspu:delete')")
