...
@Api(tags = "支付信息表 管理")
@RestController
@RequestMapping("sms/paymentinfo")
public class PaymentInfoController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('sms:paymentinfo:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('sms:paymentinfo:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('sms:paymentinfo:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('sms:paymentinfo:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('sms:paymentinfo:delete')")
