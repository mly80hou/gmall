...
@Api(tags = "订单退货申请 管理")
@RestController
@RequestMapping("sms/orderreturnapply")
public class OrderReturnApplyController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('sms:orderreturnapply:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('sms:orderreturnapply:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('sms:orderreturnapply:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('sms:orderreturnapply:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('sms:orderreturnapply:delete')")
