...
@RestController
@RequestMapping("sms/orderoperatehistory")
public class OrderOperateHistoryController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('sms:orderoperatehistory:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('sms:orderoperatehistory:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('sms:orderoperatehistory:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('sms:orderoperatehistory:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('sms:orderoperatehistory:delete')")
